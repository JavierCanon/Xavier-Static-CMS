Namespace WYSIWYG
  Public Module Editor
    ...
    Private Sub AddTo(TextArea As Control, Optional AddCenterButton As Boolean = False)
      ...
      Editor.ID = "editor" : Editor.Attributes.Add("contenteditable", "true") : Editor.Style.Add("border-style", "dashed") : Editor.Style.Add("width", "inherit") : Editor.Style.Add("overflow-y", "scroll") : Editor.Style.Add("padding", "10px")
